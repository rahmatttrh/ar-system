@extends('account_receivable.layouts.app')
@section('title')
    Dashboard
@endsection

@section('content-account_receivable')
                        ...
                        <div class="col-8">
                            <div class="vector-image">
                                <img class="img-fluid welcome-img w-200px mb-n20 mt-n5"
                                    src="{{ asset('urbix/images/dashboard/upgrade-img.png') }}" alt="CRM Vector">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="text-end">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <img src="assets/images/flag/us.svg" height="30" width="30"
                            ...
                            <img src="assets/images/flag/de.svg" height="30" width="30"
                                class="object-fit-cover rounded-circle">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                        ...
                        <div class="d-flex align-items-center gap-4 mb-5">
                            <img src="assets/images/flag/ru.svg" height="30" width="30"
                                class="object-fit-cover rounded-circle">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                            ...
                            <img src="assets/images/flag/cn.svg" height="30" width="30"
                                class="object-fit-cover rounded-circle">
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center fs-13">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body product-body bg-body m-4 mt-0">
                                <img src="assets/images/dashboard/shoeses.png"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <img src="assets/images/dashboard/enhanced_image.png" class="img-fluid"
                                        alt="Enhanced Image">
                                </div>
